...
const conversations = [
  {
    title: "Status do pedido e rastreio",
    messages: [
      { text: "Oi! Estou com dúvida sobre o pedido #8451. Já foi enviado?", sender: "customer", delay: 0 },
      {
        text: "Posso verificar para você. Qual e-mail foi usado na compra?",
        sender: "ai",
        delay: 1000,
      },
      {
        text: "Foi maria@exemplo.com.",
        sender: "customer",
        delay: 2500,
      },
      {
        text: "Obrigado! O pedido #8451 foi enviado hoje e o rastreio é BR123456789.",
        sender: "ai",
        delay: 3500,
      },
      { text: "Você pode enviar o link?", sender: "customer", delay: 5000 },
      {
        text: "Claro! Enviei o link por e-mail. Quer receber também no WhatsApp?",
        sender: "ai",
        delay: 6000,
      },
    ],
  },
  {
    ...
    messages: [
      { text: "Vocês atendem por WhatsApp e Instagram?", sender: "customer", delay: 0 },
      {
        text: "Sim! O CHAT - SPX unifica WhatsApp, Instagram, e-mail e chat do site.",
        sender: "ai",
        delay: 1000,
      },
      {
        text: "Preciso integrar com o Slack.",
        sender: "customer",
        delay: 2500,
      },
      {
        text: "Temos integração com Slack e webhooks. Quer que eu abra um ticket para o time técnico?",
        sender: "ai",
        delay: 4000,
      },
      { text: "Pode abrir, por favor.", sender: "customer", delay: 5500 },
      {
        text: "Ticket criado e enviado para o Slack do time. Você receberá atualizações por e-mail.",
        sender: "ai",
        delay: 6500,
      },
    ],
  ...
  {
    title: "Ajuda fora do horário",
    messages: [
      { text: "Boa noite, preciso resetar minha senha.", sender: "customer", delay: 0 },
      {
        text: "Sem problemas. Posso enviar um link de recuperação agora.",
        sender: "ai",
        delay: 1000,
      },
      { text: "Ok, pode enviar.", sender: "customer", delay: 2500 },
      { text: "Pronto! Se não chegar, posso abrir um atendimento com a equipe.", sender: "ai", delay: 3500 },
    ],
  },
]
      ...
      <div className="bg-white rounded-b-[3rem] pt-16 sm:pt-24 pb-16 sm:pb-24 px-4 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            >
              Veja como o Captain resolve dúvidas, faz triagem e mantém o atendimento 24/7.
            </p>
          </div>
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center lg:h-[600px] space-y-6 lg:space-y-8 order-2 lg:order-1">
              ...
              >
                <h3 className="text-2xl lg:text-3xl font-bold text-slate-900 mb-4 lg:mb-6">
                  Isto é o que seus clientes veem
                </h3>

                <div className="space-y-3 lg:space-y-4 text-base lg:text-lg text-slate-700 leading-relaxed">
                  <p>
                    Enquanto sua equipe está em atendimento, o Captain responde dúvidas e direciona conversas 24/7.
                  </p>

                  <p>Cada conversa pode acontecer fora do horário ou em momentos de pico.</p>

                  <p className="text-lg lg:text-xl font-semibold text-slate-900">
                    Seu time entra com contexto completo.
                  </p>
                </div>
              </div>
              ...
              >
                <div className="p-4 lg:p-6 bg-blue-50 rounded-xl border-l-4 border-blue-600">
                  ...
                  <p className="text-xs lg:text-sm text-slate-600 mt-2">— Fernanda Lima, Gerente de Suporte</p>
                </div>
              </div>
            </div>
                        ...
                        <div className="bg-slate-900 px-6 py-4 text-white">
                          <div className="flex items-center gap-3">
                            <img
                              ...
                              alt="Captain - Agente de IA"
                              className="w-8 h-8 rounded-full object-cover mr-2 mt-1 flex-shrink-0"
                            />
                            <div className="flex-1">
                              <h3 className="font-semibold text-sm">Captain - Agente de IA</h3>
                              <p className="text-xs text-slate-300">Chat com o suporte</p>
                            </div>
