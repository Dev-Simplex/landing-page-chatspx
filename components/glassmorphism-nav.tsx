          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-4 py-3 md:px-6 md:py-2">
            <div className="flex items-center justify-between">
              ...
              >
                <div className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center">
                  <Image
                    ...
                    width={40}
                    height={40}
                    className="w-full h-full object-contain scale-150 md:scale-[1.75]"
                  />
                </div>
              </Link>
              ...
              <div className="hidden md:block">
                ...
                >
                  <Image src="/whatsapp.png" alt="" width={16} height={16} className="mr-2 h-4 w-4" />
                  <span className="mr-2">Falar com a equipe</span>
