      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto text-balance">
            Calcule quanto a sua operação pode crescer com automação e IA no atendimento
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-10 items-stretch">
          ...
          >
            <Card className="p-6 md:p-8 bg-[radial-gradient(35%_128px_at_50%_0%,theme(backgroundColor.white/15%),theme(backgroundColor.white/5%))] border-white/20 backdrop-blur-sm shadow-2xl h-full flex flex-col">
              <h3 className="text-xl md:text-2xl font-semibold text-white mb-6 md:mb-8">Seus indicadores</h3>
              ...
              <div className="space-y-8 flex-1">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-3">
                    ...
                    <span className="text-white font-semibold">{inputs.monthlyVisitors.toLocaleString("pt-BR")}</span>
                  </label>
                  <Slider
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-3">
                    Ticket médio:{" "}
                    <span className="text-white font-semibold">R${inputs.averageOrderValue.toLocaleString("pt-BR")}</span>
                  </label>
                  <Slider
                  ...
                  <div className="flex justify-between text-xs text-gray-400 mt-1">
                    <span>R$25</span>
                    <span>R${businessConfig.maxOrder.toLocaleString("pt-BR")}</span>
                  </div>
                </div>
              ...
              <div className="mt-6 lg:hidden">
                <div className="flex items-center justify-center gap-2 p-3 rounded-lg bg-primary/10 border border-primary/20">
                  ...
                  <span className="text-sm text-primary font-medium">Role para ver seus resultados</span>
                </div>
              </div>

              <div className="mt-8 pt-6 border-t border-gray-700/50">
                <div className="space-y-4">
                  <h4 className="text-sm font-semibold text-gray-300 mb-3">💡 Insights do setor</h4>
                  <div className="space-y-3">
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-white/5">
                      <div className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0"></div>
                      <div>
                        <p className="text-sm text-gray-300">
                          <span className="font-medium text-white">Melhora média:</span> negócios veem{" "}
                          {businessConfig.conversion}% de aumento de conversão em 30 dias
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-white/5">
                      ...
                      <div>
                        <p className="text-sm text-gray-300">
                          <span className="font-medium text-white">Tempo de resposta:</span> IA responde{" "}
                          {businessConfig.response}% mais rápido que métodos tradicionais
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-white/5">
                      ...
                      <div>
                        <p className="text-sm text-gray-300">
                          <span className="font-medium text-white">Satisfação do cliente:</span> cresce{" "}
                          {businessConfig.satisfaction}% com suporte 24/7
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="space-y-6 flex-1">
                ...
                <div className="grid grid-cols-2 gap-3 md:gap-4">
                  <div className="text-center p-3 md:p-4 rounded-lg bg-gray-700/30">
                    <div className="text-xs md:text-sm text-gray-400 mb-1">Atual</div>
                    <div className="text-xl md:text-2xl font-bold text-white">
                      {currentLeads.toLocaleString("pt-BR")}
                    </div>
                    <div className="text-xs text-gray-400">contatos/mês</div>
                  </div>
                  <div className="text-center p-3 md:p-4 rounded-lg bg-white/10 border border-white/20">
                    <div className="text-xs md:text-sm text-gray-300 mb-1">Com CHAT - SPX</div>
                    <div className="text-xl md:text-2xl font-bold text-white">{newLeads.toLocaleString("pt-BR")}</div>
                    <div className="text-xs text-gray-300">contatos/mês</div>
                  </div>
                </div>
                ...
                <div className="space-y-3 md:space-y-4">
                  <div className="flex items-center justify-between p-3 md:p-4 rounded-lg bg-white/5 border border-white/10">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm md:text-base text-white">Contatos adicionais</span>
                    </div>
                    <span className="text-lg md:text-xl font-bold text-white">
                      +{additionalLeads.toLocaleString("pt-BR")}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 md:p-4 rounded-lg bg-white/5 border border-white/10">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm md:text-base text-white">Receita adicional</span>
                    </div>
                    <span className="text-lg md:text-xl font-bold text-white">
                  ...
                  <div className="flex items-center justify-between p-3 md:p-4 rounded-lg bg-white/5 border border-white/10">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm md:text-base text-white">Aumento de receita</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 md:p-4 rounded-lg bg-white/5 border border-white/10">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm md:text-base text-white">Tempo de resposta</span>
                    </div>
                ...
                <div className="mt-6 md:mt-8 p-4 md:p-6 rounded-lg bg-white/5 border border-white/10">
                  <div className="text-center">
                    <div className="text-xs md:text-sm text-gray-300 mb-2">Projeção anual de receita adicional</div>
                    <div className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-2">
                      R${(additionalRevenue * 12).toLocaleString("pt-BR")}
                    </div>
                    <div className="text-xs md:text-sm text-gray-400">
                      Baseado nos seus indicadores atuais e benchmarks do setor
                    </div>
                  </div>
                </div>
              </div>
        ...
        >
          <p className="text-sm text-gray-400 mt-4">
            * Resultados baseados em médias do setor e podem variar por negócio
          </p>
        </div>
      </div>
    </section>
