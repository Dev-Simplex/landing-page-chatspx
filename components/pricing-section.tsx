...
const plans = [
  {
    ...
    tone: {
      ...
      badge: "bg-sky-400/15 text-sky-100 border border-sky-400/30",
      glow: "hover:shadow-[0_0_32px_-12px_rgba(56,189,248,0.45)]",
      button:
        "bg-sky-500 text-white hover:bg-sky-400 focus-visible:ring-sky-400 hover:shadow-[0_0_20px_-8px_rgba(56,189,248,0.6)]",
    },
    features: [
  ...
  },
  {
    ...
    tone: {
      ...
      badge: "bg-blue-400/15 text-blue-100 border border-blue-400/30",
      glow: "hover:shadow-[0_0_32px_-12px_rgba(96,165,250,0.45)]",
      button:
        "bg-blue-500 text-white hover:bg-blue-400 focus-visible:ring-blue-400 hover:shadow-[0_0_20px_-8px_rgba(96,165,250,0.6)]",
    },
    features: [
  ...
  },
  {
    ...
    tone: {
      ...
      badge: "bg-indigo-400/15 text-indigo-100 border border-indigo-400/30",
      glow: "hover:shadow-[0_0_32px_-12px_rgba(129,140,248,0.45)]",
      button:
        "bg-indigo-500 text-white hover:bg-indigo-400 focus-visible:ring-indigo-400 hover:shadow-[0_0_20px_-8px_rgba(129,140,248,0.6)]",
    },
    features: [
...
const addOns = [
  ...
  },
  {
    ...
    icon: Users,
    tone: "text-blue-400",
    glow: "hover:border-blue-400/40 hover:shadow-[0_0_20px_-12px_rgba(96,165,250,0.45)]",
  },
  {
    name: "Fluxo de IA",
    price: "R$ 120,00",
    ...
    glow: "hover:border-purple-400/40 hover:shadow-[0_0_20px_-12px_rgba(192,132,252,0.45)]",
  },
  {
    name: "Dashboards",
    price: "R$ 1.200,00",
    ...
    icon: BarChart3,
    tone: "text-sky-400",
    glow: "hover:border-sky-400/40 hover:shadow-[0_0_20px_-12px_rgba(56,189,248,0.45)]",
  },
  {
    ...
    glow: "hover:border-indigo-400/40 hover:shadow-[0_0_20px_-12px_rgba(129,140,248,0.45)]",
  },
]
